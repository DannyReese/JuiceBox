...
async function createInitinalPosts() {
    try {
        const [albert, sandra, glamgal] = await getAllUser();
...
async function makeTableTags() {
    try {
        ...
        console.error('could not make tags table')
        throw error
    }
};

async function makeTablePostTags() {
    try {
        ...
        console.log("table post tags")
    } catch (error) {
        console.error('could not create table post_tags');
        throw error;
    }
}
